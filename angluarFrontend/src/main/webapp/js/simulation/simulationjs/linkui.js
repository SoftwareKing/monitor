function HtmlLabelLinkUISimulation(network, element) {
    HtmlLabelLinkUISimulation.superClass.constructor.call(this, network, element);
}
twaver.Util.ext(HtmlLabelLinkUISimulation, twaver.network.LinkUI, {
...
function HtmlLabelLinkSimulation(id, from, to) {
    HtmlLabelLinkSimulation.superClass.constructor.call(this, id, from, to);
}
twaver.Util.ext(HtmlLabelLinkSimulation, twaver.Link, {
    getElementUIClass: function () {
        return HtmlLabelLinkUISimulation;
    }
});
