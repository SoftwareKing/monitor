...
!function ($) {
    ...
    var Datetimepicker = function (element, options) {
        ...
        this.allowClear = options.allowClear || this.element.data('allow-clear')||true;
    ...
    Datetimepicker.prototype = {
        ...
        fill: function () {
            ...
            if(this.allowClear==true){
                this.picker.find('tfoot th i.fa-times').parent().click(function(){
                    picker.reset();
                });
            }else{
                this.picker.find('tfoot th i.fa-times').remove();
            }
            this.updateNavArrows();
            this.fillMonths();
    ...
    var DPGlobal = {
        ...
        footTemplate:     '<tfoot><tr><th colspan="6" class="today"></th><th><i class="fa fa-times icon-remove"></i></th></tr></tfoot>'
    };
