...
@ManagedResource(objectName = "dnt.monitor.server:type=extension,name=switchService")
class SwitchManager<S extends Switch> extends DeviceManager<S> implements SwitchService<S> {
    @Autowired
