...
@Service
@Transactional
class ResourceManager<R extends Resource> extends ApplicationSupportBean
    ...
    public R findById(Long id) {
        ...
        if (resource == null)
            throw new ResourceNotFoundException("Can't find resource with id = " + id);
    ...
    protected void cascadeCreate(R resource){
        logger.warn("Does nothing for cascade create components of {}", resource);
    }
    ...
    public final R update(R legacy, R updating) throws ResourceException {
        ...
        try {
            ...
            if (logger.isInfoEnabled()) {
                ...
                logger.info("Updated  {} by {}", legacy, StringUtils.abbreviate(differences, 100 ));
            }
        } catch (ResourceException e) {
