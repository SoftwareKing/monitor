...
class ServiceManager extends Bean
    ...
    public ResourceService locate(String type) throws ResourceException {
        if (type == null)
        ...
        if (service == null){
            ...
            return locate(parentType);
        }
        return service;
    }

    public ResourceService locate(Class<? extends Resource> klass) throws ResourceException{
        MetaResource metaResource = metaService.getMetaResource(klass);
        return locate(metaResource.getType());
    }

    @Override
    public LinkService locateLinkService(Link link) throws ResourceException {
