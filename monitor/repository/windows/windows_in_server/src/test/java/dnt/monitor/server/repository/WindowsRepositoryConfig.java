...
/**
 * <h1>为 Windows Repository层 提供的单元测试环境</h1>
 */
@Configuration
@Import(DatabaseConfig.class)
public class WindowsRepositoryConfig extends RepositoryConfig {
    @Autowired
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        context.getBean("hostRepository");
    }
    ...
    protected String[] sqlScripts() {
        return new String[]{
                ...
                "classpath:META-INF/migrate/20141231204051_create_windows_view.sql@up",
                "classpath:META-INF/migrate/20141231205256_create_win_services.sql@up",
                ...
                "classpath:META-INF/migrate/20141231205731_insert_win_services.sql@up",
        };
    }
}
