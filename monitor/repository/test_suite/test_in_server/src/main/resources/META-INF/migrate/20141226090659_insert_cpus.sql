...
INSERT INTO components (id, resource_id, type, label, performance, config_status, availability) VALUES
  (1,  4, 'dnt.monitor.CPU', '总CPU', 'Normal', 'Unknown',   'Available'),
  (2,  4, 'dnt.monitor.CPU', 'CPU-1', 'Normal', 'Unknown',  'Available'),
  (3,  4, 'dnt.monitor.CPU', 'CPU-2', 'Normal', 'Unknown',  'Available'),
  (4,  4, 'dnt.monitor.CPU', 'CPU-3', 'Normal', 'Unknown',  'Available'),
  (5,  4, 'dnt.monitor.CPU', 'CPU-4', 'Normal', 'Unknown',  'Available'),

  (6,  5, 'dnt.monitor.CPU', '总CPU', 'Normal', 'Unknown',   'Available'),
  (7,  5, 'dnt.monitor.CPU', 'CPU-1', 'Normal', 'Unknown',  'Available'),
  (8,  5, 'dnt.monitor.CPU', 'CPU-2', 'Normal', 'Unknown',  'Available'),
  (9,  5, 'dnt.monitor.CPU', 'CPU-3', 'Normal', 'Unknown',  'Available'),
  (10, 5, 'dnt.monitor.CPU', 'CPU-4', 'Normal', 'Unknown',  'Available'),
  (11, 5, 'dnt.monitor.CPU', 'CPU-5', 'Normal', 'Unknown',  'Available'),
  (12, 5, 'dnt.monitor.CPU', 'CPU-6', 'Normal', 'Unknown',  'Available'),
  (13, 5, 'dnt.monitor.CPU', 'CPU-7', 'Normal', 'Unknown',  'Available'),
  (14, 5, 'dnt.monitor.CPU', 'CPU-8', 'Normal', 'Unknown',  'Available'),

  (15, 6, 'dnt.monitor.CPU', '总CPU', 'Normal', 'Unknown',   'Available'),
  (16, 6, 'dnt.monitor.CPU', 'CPU-1', 'Normal', 'Unknown',  'Available'),
  (17, 6, 'dnt.monitor.CPU', 'CPU-2', 'Normal', 'Unknown',  'Available'),
  (18, 6, 'dnt.monitor.CPU', 'CPU-3', 'Normal', 'Unknown',  'Available'),
  (19, 6, 'dnt.monitor.CPU', 'CPU-4', 'Normal', 'Unknown',  'Available'),
  (20, 6, 'dnt.monitor.CPU', 'CPU-5', 'Normal', 'Unknown',  'Available'),
  (21, 6, 'dnt.monitor.CPU', 'CPU-6', 'Normal', 'Unknown',  'Available'),
  (22, 6, 'dnt.monitor.CPU', 'CPU-7', 'Normal', 'Unknown',  'Available'),
  (23, 6, 'dnt.monitor.CPU', 'CPU-8', 'Normal', 'Unknown',  'Available'),

  (24, 7, 'dnt.monitor.CPU', '总CPU', 'Normal', 'Unknown',   'Available'),
  (25, 7, 'dnt.monitor.CPU', 'CPU-1', 'Normal', 'Unknown',  'Available'),
  (26, 7, 'dnt.monitor.CPU', 'CPU-2', 'Normal', 'Unknown',  'Available'),
  (27, 7, 'dnt.monitor.CPU', 'CPU-3', 'Normal', 'Unknown',  'Available'),
  (28, 7, 'dnt.monitor.CPU', 'CPU-4', 'Normal', 'Unknown',  'Available'),
  (29, 7, 'dnt.monitor.CPU', 'CPU-5', 'Normal', 'Unknown',  'Available'),
  (30, 7, 'dnt.monitor.CPU', 'CPU-6', 'Normal', 'Unknown',  'Available'),
  (31, 7, 'dnt.monitor.CPU', 'CPU-7', 'Normal', 'Unknown',  'Available'),
  (32, 7, 'dnt.monitor.CPU', 'CPU-8', 'Normal', 'Unknown',  'Available'),
  (33, 7, 'dnt.monitor.CPU', 'CPU-9', 'Normal', 'Unknown',  'Available'),
  (34, 7, 'dnt.monitor.CPU', 'CPU-10', 'Normal', 'Unknown', 'Available'),
  (35, 7, 'dnt.monitor.CPU', 'CPU-11', 'Normal', 'Unknown', 'Available'),
  (36, 7, 'dnt.monitor.CPU', 'CPU-12', 'Normal', 'Unknown', 'Available');

INSERT INTO t_cpus(tid, idx, model_name, frequency, `usage`, usr_usage, sys_usage, idle, io_wait) VALUES
  (1, "all",'QEMU Virtual CPU version 2.0.0', 2533.42, 0.47, 0.31, 0.16, 0.51, 0.17),
  ...
  (6, "all",'QEMU Virtual CPU version 2.0.0', 2533.42, 0.47, 0.31, 0.16, 0.51, 0.17),
  ...
  (15,"all",'Intel Core I5', 2486.13, 0.47, 0.31, 0.16, 0.51, 0.17),
  ...
  (24,"all",'Intel Core I5', 2486.13, 0.47, 0.31, 0.16, 0.51, 0.17),
