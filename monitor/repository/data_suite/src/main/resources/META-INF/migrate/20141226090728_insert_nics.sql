...
INSERT INTO components (id, resource_id, type, label, keyed, performance, config_status, availability) VALUES
  (444,  4, 'dnt.monitor.NIC', 'Realtek 3021', TRUE, 'Normal', 'Unknown', 'Available'),
  (445,  5, 'dnt.monitor.NIC', 'Realtek 3021', TRUE, 'Normal', 'Changed', 'Available'),
  (446,  6, 'dnt.monitor.NIC', 'Common NIC',   TRUE, 'Normal', 'Unknown', 'Available'),
  (447,  7, 'dnt.monitor.NIC', 'Common NIC',   TRUE, 'Normal', 'Changed', 'Available');

INSERT INTO t_nics (tid, `index`, if_type, address, speed, mtu, admin_status, `usage`, queue_length, rx, tx, rtx, trx, ttx, trtx, in_pkts, in_errs, out_pkts, out_errs, collisions) VALUES
