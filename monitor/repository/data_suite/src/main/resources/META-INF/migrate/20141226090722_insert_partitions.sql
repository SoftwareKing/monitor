...
INSERT INTO components (id, resource_id, type, label, keyed, performance, config_status, availability) VALUES
  (336,  4, 'dnt.monitor.Partition', '/',        TRUE, 'Normal', 'Unknown', 'Available'),
  (337,  4, 'dnt.monitor.Partition', '/opt',     TRUE, 'Normal', 'Changed', 'Available'),
  (338,  5, 'dnt.monitor.Partition', '/',        TRUE, 'Normal', 'Unknown', 'Available'),
  (339,  5, 'dnt.monitor.Partition', '/u01',     TRUE, 'Normal', 'Changed', 'Available'),
  (340,  6, 'dnt.monitor.Partition', 'System',   TRUE, 'Normal', 'Unknown', 'Available'),
  (341,  6, 'dnt.monitor.Partition', 'Documents',TRUE, 'Normal', 'Changed', 'Available'),
  (342,  7, 'dnt.monitor.Partition', 'System',   TRUE, 'Normal', 'Unknown', 'Available'),
  (343,  7, 'dnt.monitor.Partition', 'Documents',TRUE, 'Normal', 'Changed', 'Available');
