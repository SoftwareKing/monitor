...
INSERT INTO components (id, resource_id, type, label, keyed, performance, config_status, availability) VALUES
  (228,  4, 'dnt.monitor.Disk', 'Toshiba HDD',      TRUE, 'Normal', 'Unknown', 'Available'),
  (229,  4, 'dnt.monitor.Disk', 'West Digital HDD', TRUE, 'Normal', 'Unknown', 'Available'),
  (230,  5, 'dnt.monitor.Disk', 'Toshiba HDD',      TRUE, 'Normal', 'Unknown', 'Available'),
  (231,  5, 'dnt.monitor.Disk', 'West Digital HDD', TRUE, 'Normal', 'Unknown', 'Available'),
  (232,  6, 'dnt.monitor.Disk', 'West Digital HDD', TRUE, 'Normal', 'Unknown', 'Available'),
  (233,  6, 'dnt.monitor.Disk', 'Toshiba HDD',      TRUE, 'Normal', 'Unknown', 'Available'),
  (234,  7, 'dnt.monitor.Disk', 'West Digital HDD', TRUE, 'Normal', 'Unknown', 'Available'),
  (235,  7, 'dnt.monitor.Disk', 'Toshiba HDD',      TRUE, 'Normal', 'Unknown', 'Available');
