...
INSERT INTO resources(id, type, address, performance, config_status, availability, properties, label) VALUES
  (1, '/application/monitor_server', 'localhost',    'Normal',  'Unchanged', 'Available',  NULL, '监控服务器'),
  (2, '/application/monitor_engine', 'localhost',    'Normal',  'Unchanged', 'Available',  NULL, '缺省监控引擎'),
  (3, '/application/monitor_engine', '172.16.1.14',  'Normal',  'Unchanged', 'Available',  NULL, '监控引擎#2'),
