...
INSERT INTO components (id, resource_id, type, label, keyed, performance, config_status, availability) VALUES
  (124,  4, 'dnt.monitor.Memory', '内存', TRUE ,'Normal', 'Unknown', 'Available'),
  (125,  5, 'dnt.monitor.Memory', '内存', TRUE ,'Normal', 'Unknown', 'Available'),
  (126,  6, 'dnt.monitor.Memory', '内存', TRUE ,'Normal', 'Unknown', 'Available'),
  (127,  7, 'dnt.monitor.Memory', '内存', TRUE ,'Normal', 'Unknown', 'Available');
