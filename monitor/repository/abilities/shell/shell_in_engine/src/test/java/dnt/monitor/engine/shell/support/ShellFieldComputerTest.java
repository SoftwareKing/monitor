...
@ContextConfiguration(classes = ShellFieldComputerTest.TestConfig.class)
@Ignore("After refactor, there are not valid meta resource(linux host)")
public class ShellFieldComputerTest {
    ...
    public void initLinux() throws Exception {
        linux = (MetaResource) metaService.getMetaResources("/device/host/linux");
    }
    ...
    public void testConverterFormat() throws Exception {
        ...
        field.setAttribute(MetaValue.class, metaValue);
