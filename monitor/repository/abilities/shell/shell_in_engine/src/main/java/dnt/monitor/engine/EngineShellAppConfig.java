...
/**
 * <h1>Shell in Engine side App Configuration</h1>
 *
 * @author Jay Xiong
 */
@Configuration
@ComponentScan({"dnt.monitor.engine.shell"})
@Import(DefinitionUserConfig.class)
public class EngineShellAppConfig extends EngineDefinitionAppConfig {

    @Override
    public void doExports() {
        exports(GenericSampleService.class, "shell");
        exports(ShellVisitorFactory.class);
    }
}
