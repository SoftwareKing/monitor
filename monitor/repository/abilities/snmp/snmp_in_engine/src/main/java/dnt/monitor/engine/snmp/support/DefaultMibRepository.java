 ...
 */
@Component
@ManagedResource(objectName = "dnt.monitor.engine:type=service,name=mibRepository")
public class DefaultMibRepository extends Bean implements MibRepository {
    ...
    public void preLoad(Resource[] resources) {
        //for test purpose, just meet this case in test env
        if( !isRunning() ) start();
        ...
        for (Resource resource : resources) {
            try {
                ...
                logger.warn("Failed to pre-load {}, because of {}",
                            resource.getDescription(), describeException(e));
            }
        }
    }
    ...
    public void load(String... modules) {
        for (String module : modules) {
            try {
                ...
                logger.warn("Failed to load {}, because of {}", module, describeException(e));
    ...
    void loadFromFileSystem(File mibRoot) {
        ...
        for (File file : files) {
            ...
            try {
                ...
                logger.warn("Failed to load MIB file {}, because of {}", file, describeException(e));
            } catch (MibLoaderException e) {
