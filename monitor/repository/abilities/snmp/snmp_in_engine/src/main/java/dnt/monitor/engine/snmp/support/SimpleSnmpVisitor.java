 ...
 * @author Jay Xiong
 */
class SimpleSnmpVisitor extends AbstractVisitor<SnmpCredential> implements SnmpVisitor {
    protected final Target         target;
    protected final Snmp           snmp;

    public SimpleSnmpVisitor(ManagedNode node,
                             Resource resource,
    ...
    public boolean isAvailable() {
        try {
            get(MILLIS_PER_SECOND * 30, "1.3.6.1.2.1.1.1.0");
            return true;
    ...
    public Object get(String oid) throws SnmpException {
        return get(target.getTimeout(), oid);
    }

    @Override
    public Object get(long timeout, final String oid) throws SnmpException {
        return withTimeout(timeout, new Callable<Object>() {
            @Override
    ...
    public GeneralMap<String, Object> gets(String... oids) throws SnmpException {
        return gets(target.getTimeout(), oids);
    }

    @Override
    public GeneralMap<String, Object> gets(long timeout, final String... oids) throws SnmpException {
        return withTimeout(timeout, new Callable<GeneralMap<String, Object>>() {
            @Override
            public GeneralMap<String, Object> call() throws Exception {
    ...
    public GeneralMap<String, Object> bulk(String... oids) throws SnmpException {
        return bulk(target.getTimeout(), oids);
    }

    @Override
    public GeneralMap<String, Object> bulk(long timeout, final String... oids) throws SnmpException {
        return withTimeout(timeout, new Callable<GeneralMap<String, Object>>() {
            @Override
            public GeneralMap<String, Object> call() throws Exception {
    ...
    public GeneralMap<String, Object> walk(String oid) throws SnmpException {
        return walk(target.getTimeout(), oid);
    }

    @Override
    public GeneralMap<String, Object> walk(long timeout, final String oid) throws SnmpException {
        return withTimeout(timeout, new Callable<GeneralMap<String, Object>>() {
            @Override
            public GeneralMap<String, Object> call() throws Exception {
    ...
    <T> T withTimeout(long timeout, Callable<T> callable) throws SnmpException {
        ...
        try {
            ...
            try {
                ...
                throw new SnmpException(PROBE_SAMPLE_ERROR, e);
            }
        } finally {
