...
public interface IpServiceDiscover extends PriorityOrdered {
     ...
     * @return 是否可用
     */
    boolean isCredentialAvailable(ResourceNode node, Credential credential);
     ...
     * @return 发现之后的设备实例
     */
    Device discover(ResourceNode node, Credential credential) throws DiscoveryException;
