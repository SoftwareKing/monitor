...
AutoPackTable = function (dataBox) {
    AutoPackTable.superClass.constructor.call(this, dataBox);
};
twaver.Util.ext('AutoPackTable', twaver.controls.Table, {
    _minPackWidth: 100,
    ...
    adjustBounds: function (rect) {
        AutoPackTable.superClass.adjustBounds.call(this, rect);
...
AutoPackTreeTable = function (dataBox) {
