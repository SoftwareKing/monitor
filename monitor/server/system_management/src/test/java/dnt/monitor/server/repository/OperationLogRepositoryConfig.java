...
public class OperationLogRepositoryConfig extends RepositoryConfig
{
    @Autowired
    ...
    protected String[] sqlScripts()
    {
        return new String[]
                {
                        "classpath:META-INF/migrate/20141229155500_create_operation_logs.sql@up",
                        "classpath:META-INF/setup/insert_operation_logs.sql@up"
                };
    }
}
