 ...
 */
@Component
public class SshFieldComputer extends Bean implements FieldComputer {
    ...
    public Object computeField(MetaField metaField, Map<String, Object> valueMap) throws SampleException {
        MetaValue metaValue = metaField.getValue();
        ...
        if (metaValue == null || StringUtils.isBlank(metaValue.getValue())) {
            if (valueMap.containsKey(metaField.getName())) {
                ...
                return computeField(metaField, valueText);
            }else{
                return null;
            }
        }
        ...
        try {
            ...
            if (isNumberType) {
                valueText = expression.getValue(standardEvaluationContext, context, Double.class) + "";
            } else {
    ...
    private Object computeField(MetaField metaField, String valueText) throws SampleException {
